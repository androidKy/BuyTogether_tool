...
public class BackupConstant {
    ...
    //拼多多数据存放路径
    public static final String PDD_DATA_ZIP_PATH = SDCARD_PATH + "backupData" + File.separator + Constant.BUY_TOGETHER_PKG;
    //拼多多数据解压存放的路径
    public static final String PDD_DATA_UNZIP_PATH = SDCARD_PATH + "backupData" + File.separator;
