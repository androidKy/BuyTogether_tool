...
/*
    ...
    private void zipFile() {
        ThreadUtils.executeByCached(new ThreadUtils.Task<String>() {
            ...
            public String doInBackground() throws Throwable {
                String ignoreFile = "rm -fr /sdcard/backupData/" + Constant.BUY_TOGETHER_PKG + "/tinker;" +
                        // "rm -fr /sdcard/backupData/" + Constant.BUY_TOGETHER_PKG +"/files;"+  //删除这个文件夹，权限需要重新授予
                        "rm -fr /sdcard/backupData/" + Constant.BUY_TOGETHER_PKG + "/cache;";
            ...
            public void onSuccess(String result) {
                ...
                zip.startZip(BackupConstant.PDD_DATA_ZIP_PATH);   //todo 只备份拼多多的数据
            }
    ...
    private void unZip() {
        L.i(TAG, "开始解压》》》》》》");
        File cacheFile = new File(BackupConstant.PDD_DATA_ZIP_PATH);
        if (cacheFile.exists()) {
            cacheFile.delete();
        }
        ...
        if (file.exists()) {
            ...
            ZipUtils.unZip(zipFilePath, BackupConstant.PDD_DATA_UNZIP_PATH);
            //file.delete();
