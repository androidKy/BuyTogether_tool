...
public class DNSProxy implements Runnable {
    ...
    private final String TAG = "DNSProxy";
    ...
    private String resolveDomainName(String domain) {
        ...
        String url = "http://80.92.90.248/api/dns/8.8.8.8/IN/" + domain + "/A";
        ...
        Log.d(TAG, "resolveDomainName ip:" + ip);
    ...
    public byte[] fetchAnswerHTTP(byte[] quest) {
        ...
        ip = resolveDomainName(domain); //解析域名得到相应的IP
