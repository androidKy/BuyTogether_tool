...
/**
 * Description:
 * Created by Quinin on 2019-07-31.
 **/
public class LocationHook implements HookListener {
    @Override
    public void hook(@NotNull XC_LoadPackage.LoadPackageParam loadPkgParam) {
        HookAndChange(loadPkgParam.classLoader,100.80,120.0,80,100);
    }


    void HookAndChange(ClassLoader classLoader, final double latitude, final double longtitude, final int lac, final int cid) {
