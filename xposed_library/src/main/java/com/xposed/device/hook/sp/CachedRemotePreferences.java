...
/**
 * RemotePreferences that cache the key-value pairs in memory, updating when the backing SharedPreferences
 * are updated.
 * description:通过内容提供者访问跨进程的xml
 * author: kyXiao
 * date: 2019/4/8
 */
public class CachedRemotePreferences extends RemotePreferences {
    ...
    public CachedRemotePreferences(Context context, String authority, String prefName, boolean strictMode) {
